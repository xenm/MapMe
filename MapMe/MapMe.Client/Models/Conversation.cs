...
public class Conversation
{
    ...
    [JsonPropertyName("unreadCount1")]
    public int UnreadCount1 { get; set; }

    [JsonPropertyName("unreadCount2")]
    public int UnreadCount2 { get; set; }

    [JsonPropertyName("isArchived1")]
    public bool IsArchived1 { get; set; }

    [JsonPropertyName("isArchived2")]
    public bool IsArchived2 { get; set; }
