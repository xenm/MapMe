...
# Runs only Integration tests (API endpoints with in-memory repositories)
...
Write-Host "Running Integration tests (API endpoints with in-memory repositories)..." -ForegroundColor Green
