...
public sealed record ChatMessage(
    ...
    [property: JsonPropertyName("messageType")] string MessageType, // "text", "image", "location", "datemark"
    [property: JsonPropertyName("metadata")] MessageMetadata? Metadata,
...
public sealed record MessageMetadata(
    ...
    [property: JsonPropertyName("dateMarkId")] string? DateMarkId,
    [property: JsonPropertyName("dateMarkName")] string? DateMarkName
);
