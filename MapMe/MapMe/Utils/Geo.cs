...
{
    public static (double minLat, double minLng, double maxLat, double maxLng) Bbox(double lat, double lng, double radiusMeters)
    {
    ...
    public static IReadOnlyList<string> CoveringTiles((double minLat, double minLng, double maxLat, double maxLng) bbox, int precision, double stepDegrees)
    {
