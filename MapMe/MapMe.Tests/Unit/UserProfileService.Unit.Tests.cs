...
public class UserProfileServiceTests
{
    ...
    {
        // Arrange
        var profile = new MapMe.Client.Models.UserProfile
        {
            Id = "test-id",
            UserId = "test-user",
            DisplayName = "Updated User",
            Bio = "Updated bio",
            Photos = new List<MapMe.Client.Models.UserPhoto>(),
    ...
    public async Task SaveDateMarkAsync_SavesNewMark_WhenNoDuplicate()
    {
        ...
        var newMark = new MapMe.Client.Models.DateMark
        {
            Id = "test-id",
            UserId = "test-user",
            Latitude = 0,
    ...
    {
        // Arrange
        var existingMark = new MapMe.Client.Models.DateMark
        {
            Id = "test-id",
            UserId = "test-user",
            Latitude = 0,
        ...
        var updatedMark = new MapMe.Client.Models.DateMark
        {
            Id = existingMark.Id,
    ...
    public async Task GetUserActivityStatsAsync_ReturnsCorrectStats()
    {
        ...
        var dateMarks = new[]
        {
            new MapMe.Client.Models.DateMark
            {
                Id = "mark1",
                UserId = "test-user",
                Latitude = 0,
