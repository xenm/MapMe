...
public class InMemoryRepositoryTests
{
    ...
    public async Task DateMarks_InMemory_Filtering_Works()
    {
        ...
        var dm1 = new DateMark(
            ...
            UpdatedAt: now,
            IsDeleted: false);
        var dm2 = dm1 with { Id = "dm2", Categories = new[]{"art"}, CategoriesNorm = Normalization.ToNorm("art"), VisitDate = new DateOnly(2025,8,10) };
        ...
        var window = await repo.GetByUserAsync("u1", from: new DateOnly(2025,8,9), to: new DateOnly(2025,8,9)).ToListAsync();
