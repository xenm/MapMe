...
public class NewtonsoftJsonEliminationTests
{
    ...
    public void MainApplication_ShouldNotReferenceNewtonsoftJson()
    {
        ...
        foreach (var assembly in applicationAssemblies)
        {
            ...
            var newtonsoftReferences = referencedAssemblies
                .Where(refAssembly => refAssembly.Name?.Equals("Newtonsoft.Json", StringComparison.OrdinalIgnoreCase) == true)
                .ToList();
    ...
    public void SystemTextJsonCosmosSerializer_ShouldBeAvailable()
    {
        ...
        Assert.True(serializerType!.IsSubclassOf(typeof(Microsoft.Azure.Cosmos.CosmosSerializer)));
    }
    ...
    {
        // Arrange
        var serializer = new MapMe.Data.SystemTextJsonCosmosSerializer();
    ...
    public void ApplicationCode_ShouldUseSystemTextJsonExclusively()
    {
        ...
        var serializedJson = System.Text.Json.JsonSerializer.Serialize(userProfile, jsonOptions);
        var deserializedData = System.Text.Json.JsonSerializer.Deserialize<Dictionary<string, object>>(serializedJson);
