...
public class ExtendedApiIntegrationTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task DateMark_Create_WithInvalidData_ReturnsBadRequest()
    {
        ...
        var invalidRequests = new[]
        {
            new UpsertDateMarkRequest("", "user1", 37.0, -122.0, null, "Place", null, null, null, null, null, null,
                null, null, null, null, null, "public"), // Empty Id
            new UpsertDateMarkRequest("dm1", "", 37.0, -122.0, null, "Place", null, null, null, null, null, null, null,
                null, null, null, null, "public"), // Empty UserId
        };
    ...
    public async Task DateMark_FilteringCombinations_ReturnsCorrectResults()
    {
        ...
        var dateMarks = new[]
        {
            new UpsertDateMarkRequest("combo1", userId, 37.0, -122.0, null, "Restaurant A", null, null, null, null,
                null, null,
                new[] { "Restaurant", "Italian" }, new[] { "Romantic", "Expensive" },
                new[] { "Great Food", "Good Service" },
                "Perfect for dates", new DateOnly(2025, 8, 1), "public"),

            new UpsertDateMarkRequest("combo2", userId, 37.1, -122.1, null, "Cafe B", null, null, null, null, null,
                null,
    ...
    public async Task DateMark_DateRangeEdgeCases_HandlesCorrectly()
    {
        ...
        var dateMarks = new[]
        {
            ...
            new UpsertDateMarkRequest("date2", userId, 37.0, -122.0, null, "Place 2", null, null, null, null, null,
                null,
                new[] { "Restaurant" }, null, null, "Visit 2", new DateOnly(2025, 2, 28),
                "public"), // Last day of February

            new UpsertDateMarkRequest("date3", userId, 37.0, -122.0, null, "Place 3", null, null, null, null, null,
                null,
