...
public sealed record MessageMetadataDto(
    ...
    string? DateMarkId = null,
    [property: JsonPropertyName("dateMarkName")]
    string? DateMarkName = null
)
{
...
public sealed record ConversationResponse(
    ...
    [property: JsonPropertyName("otherParticipant")]
    UserSummary OtherParticipant,
    [property: JsonPropertyName("lastMessage")]
    MessageSummary? LastMessage,
    [property: JsonPropertyName("unreadCount")]
    int UnreadCount,
