...
public class ChatService
{
    ...
    /// </summary>
    public async Task<ChatMessage?> SendMessageAsync(string receiverId, string content, string messageType = "text",
    ...
    public async Task StartChatAsync(string otherUserId, DateMark dateMark)
    {
        ...
        if (!string.IsNullOrEmpty(conversationId))
        {
            ...
            var initialMessage =
                $"Hi! I saw your Date Mark at {dateMark.Name ?? "this place"} and wanted to chat about it.";
...
public class ConversationSummary
{
    ...
    [JsonPropertyName("otherParticipant")] public UserSummary OtherParticipant { get; set; } = new();

    [JsonPropertyName("lastMessage")] public MessageSummary? LastMessage { get; set; }
